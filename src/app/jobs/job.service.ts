...
export class JobsService {
  ...
  addJob(title: string, description: string, image: File, location: string, jobType: string, firm: string) {
  ...
  updateJob(id: string, title: string, description: string, image: File | string, location: string, jobType: string, firm: string) {
    ...
    this.http.put("http://localhost:3000/api/posts/" + id, jobData)
      .subscribe(response => {
